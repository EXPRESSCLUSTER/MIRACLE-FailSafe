...
[
    ...
    ['mysqlw', 'mysqlw', ['target', 'exec1'], ['relation/type', 'cls'], ['relation/name', 'LocalServer'], ['emergency/action', '1'], ['parameters/database', 'testdb'], ['parameters/username', 'root'], ['parameters/password', 'cluster-0'], ['parameters/libraryfullpath', '/usr/lib64/libmariadb.so.3']],
    []
];
##################################################
...
$ret = `$clpcfset add clsparam rstd/use 1`;
